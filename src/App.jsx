...
function App() {
  ...
  return <div className="app">
    ...
    <footer><div className="container footer-grid"><div><a className="brand" href="#top" style={{flexDirection:'column',alignItems:'flex-start'}}><img src="/aiatoz_logo.png" alt="AI A to Z — Basics to Brilliance" style={{height:'48px',width:'auto',objectFit:'contain'}} /></a><p style={{marginTop:'10px'}}>Affiliate Program</p><div style={{display:'flex',gap:'8px',marginTop:'12px',flexWrap:'wrap'}}>
          ...
          <a href="https://www.linkedin.com/company/aiatoz/home/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" style={{width:'26px',height:'26px',borderRadius:'7px',background:'#0A66C2',display:'grid',placeItems:'center'}}><svg width="14" height="14" viewBox="0 0 24 24" fill="white"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg></a>
